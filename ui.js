$(async function() {
  ...
  const $articlesParent = $("#articles-parent")
  ...
  /*Event Handler for new story submission
  submits to Hacker or Snooze
  and prepends the story to the story list */
  $submitForm.on("submit", async function(evt) {
    ...
    let htmlStory = await StoryList.addStory(currentUser, newStory);
    console.log(htmlStory);
    $allStoriesList.prepend(generateStoryHTML(htmlStory));
...
/* show user elements in Nav ofr logged in users */
